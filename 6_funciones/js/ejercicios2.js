...
function revisarCupon(cupon) {
  switch (cupon) {
    case "ABC":
      console.log(`El cupon ${cupon} tiene un valor de descuento de $1000`);
      break;
    case "DEF":
      console.log(`El cupon ${cupon} tiene un valor de descuento de $2000`);
      break;
    case "GHI":
      console.log(`El cupon ${cupon} tiene un valor de descuento de $500`);
      break;
    default:
...
calcularPerimetroTriangulo(10, 15);
...
function numeroMax(numA, numB) {
  ...
  console.log(`El numero mayor de los numeros ${numA} y ${numB} es ${numMax}`);
}
...
function numeroMin(num1, num2) {
  ...
  console.log(`El numero menor de los numeros ${num1} y ${num2} es ${numMin}`);
}

// 10. Crear una función que reciba 3 strings y nos muestre cuál tiene más caracteres
cantidadCaracteres("Perro","Gato","Cocodrilo")
function cantidadCaracteres(texto1, texto2, texto3) {
  ...
  if (numChar1 > numChar2 && numChar1 > numChar3) {
      console.log(`El texto ${texto1} es el que tiene mas caracteres`)
  }else if(numChar2 > numChar1 && numChar2 > numChar3){
    console.log(`El texto ${texto2} es el que tiene mas caracteres`)
  }else if(numChar3 > numChar1 && numChar2 < numChar3)
  console.log(`El texto ${texto3} es el que tiene mas caracteres`)
}
...
function calcularCubo(num) {
  let cubo = num ** 3;
  console.log(`El numero ${num} elevado al cubo es ${cubo}`);
}
